...
def initialize_model(input_fdim=128,input_tdim=1024, 
    ...
    # PS_Model = ASTModel(feature_dim, num_heads, hidden_dim, max_dropout, depthwise_conv_kernel_size, conformer_layers, max_pooling_factor).to(DEVICE)
    AST_model = ASTModel(label_dim=1,fstride=10, tstride=10, 
...
def initialize_lr_scheduler(optimizer,milestones, gamma):
