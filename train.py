...
def train_model(train_directory, train_labels_dict, tokenizer,feature_extractor, BATCH_SIZE=32, NUM_EPOCHS=1,LEARNING_RATE=0.001,model_save_path=os.path.join(os.getcwd(),'models\\back_end_models'),DEVICE='cpu'):
    ...
    BASE_DIR = os.getcwd()
    PartialSpoof_LA_cm_train_trl_dict_path = os.path.join(BASE_DIR,'PartialSpoof_LA_cm_train_trl.json')
