...
if __name__ == "__main__":
    ...
    inference(input_fdim=128,input_tdim=1024, imagenet_pretrain=True, audioset_pretrain=False, model_size='base384',eval_audio_conf=eval_audio_conf,
        ...
        AST_Model_path=os.path.join(os.getcwd(),f'models/back_end_models/AST_model_epochs28_batch4_lr0.0002_20250113_074818.pth'),
        BATCH_SIZE=4, num_workers=8, prefetch_factor=2, DEVICE='cuda')
