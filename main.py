...
#                 },
#                 'parameters': {
#                     'NUM_EPOCHS': {'values': [config['training']['num_epochs']]},
#                     'LEARNING_RATE': {'values': [config['training']['learning_rate']]},
#                     'BATCH_SIZE': {'values': [config['training']['batch_size']]}
#                 }
#             }
...
#         else:
#             print("Warning: WandB enabled but API key not found. Running without WandB logging.")
#             train(config)
#     else:
#         train(config)
